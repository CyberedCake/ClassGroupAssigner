...
if __name__ == "__main__":
    ...
    dictionary = {
        "name": str(name if name is not None else "autogenerated-" + str(autogenerated_name) + "-class"),
        "members": names
    }
    ...
    file = open("classes\\autogenerated-" + str(autogenerated_name) + "-class.rclass", "w")
